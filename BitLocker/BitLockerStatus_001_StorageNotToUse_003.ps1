...
#Source https://www.itprotoday.com/email-and-calendaring/get-bitlocker-recovery-information-ad-using-powershell

<#
Get BitLocker recovery information for a single computer:
